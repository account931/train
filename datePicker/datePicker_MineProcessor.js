...
$(document).ready(function(){
 ...
 // Mine Calendar Pick up action is here
...
//Start PickDate onclick calendar --------------------------
// **************************************************************************************
// **************************************************************************************
//                                                                                     **  
...
//Click Prev Day <<  day -1;
    ...
    $("#prevDay").click(function(){
        ...
        // here we split the php dtae to format that fits for '2017,9,13' format to use in New Date()-------------
        var dateSplit = FormInputFirst.split('-');   //.split('\n').join(',').split(',');  
 
         //Object with Month 
         var objectMonth = { Jan:"0",Feb:"1",Mar:"2",Apr:"3",May:"4",Jun:"5",Jul:"6",Aug:"7",Sep:"9",Oct:"10",Nov:"11", Dec:"12"};// creates object as no assoc array in JS// Version-2, seems work
         //var c = dateSplit[1];alert (c);
         //alert(objectMonth[c]);
			
	     //get the 2nd array element (i.e month(Feb,etc), find it position in array, make +1
	     var monthSplit = Monthh.indexOf(dateSplit[1]);   
		 monthSplit = parseInt(monthSplit) + 1;        
			
         var adoptedDateFormat = dateSplit[3] + "," + /*objectMonth[dateSplit[1]]*/ monthSplit + "," + dateSplit[0];    //set to format suitable for JS (YYYY,MM, DD)
         //alert (adoptedDateFormat);
         //END here we split the php date to format fits for '2017,9,13' format---------
...
//                                                                                     **  
    ...
    $("#nextDay").click(function(){
        ...
        // here we split the php date to format that fits for '2017,9,13' format-------------
        var dateSplit = FormInputFirst.split('-');   //.split('\n').join(',').split(',');  
...
function onLeftRightCalendarClick_ResetMainArea()
{
    ...
    $("#ajaxResponse").stop().fadeOut("slow",function(){  
	    $("#ajaxResponse").html("<center><h3 style='background-color:green;color:white; padding: 3em;'>Select table for "  + xxx +  "</h3></center>") 
	}).fadeIn(3000);
